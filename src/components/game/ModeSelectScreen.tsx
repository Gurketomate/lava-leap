    ...
    <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-background/90 backdrop-blur-sm">
      ...
      <button
        ...
        className="absolute top-4 left-4 p-3 rounded-xl glass-panel text-muted-foreground
          hover:text-foreground hover:scale-110 active:scale-95 transition-all duration-150 z-10"
      >
        <ArrowLeft size={22} />
      </button>
      ...
      <div className="flex flex-col items-center gap-8 animate-fade-in relative z-10">
        <div className="text-center relative">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-black text-primary text-glow-primary tracking-tight relative">
            SELECT MODE
          </h1>
          <p className="text-muted-foreground font-body mt-2 text-sm tracking-wider relative">
